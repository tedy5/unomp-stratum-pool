...
//    }
    ...
    logger = logger || function(logger, severity, message){
    ...
    function performHttpRequest(instance, jsonData, callback) {
        ...
        var parseJson = function (res, data) {
            ...
            if (res.statusCode !== 200) {
                logger('error', 'Daemon returned unexpected return code ' + res.statusCode + ' data = ' + JSON.stringify(data));
                return;
            }
    ...
    function cmdRPC(method, params, callback, streamResults, returnRawData) {
        ...
        async.each(instances, function (instance, eachCallback) {
            ...
            performHttpRequest(instances[0], requestJson, function (error, result, data) {
                itemFinished(error, result, data);
            });
