...
//                logger.info('mining.subscribe message from  miners');
                handleSubscribe(message);
                break;
            case 'mining.authorize':
                logger.info('mining.authorize message from  miner');
                handleAuthorize(message, true /*reply to socket*/);
                break;
            case 'mining.get_multiplier':
                logger.info('mining.get_multiplier message from  miner');
                ...
                break;
            case 'ping':
                logger.info('ping message from  miner');
            ...
            case 'mining.submit':
                _this.lastActivity = Date.now();
                logger.info('mining.submit message from  miner');
            ...
            case 'mining.get_transactions':
                ...
                logger.info('mining.get_transactionsfrom  miner, message = %s');
                break;
            default:
